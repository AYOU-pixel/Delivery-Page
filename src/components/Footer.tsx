      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <a href="/" className="text-2xl font-poppins font-bold">
              Bite<span className="text-primary">Bliss</span>
            </a>
            <p className="mt-4 text-gray-400 font-inter">
              Delicious food delivered fast to your doorstep. Enjoy restaurant-quality meals in the comfort of your home.
            </p>
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 font-inter text-sm">
            © {currentYear} BiteBliss. All rights reserved.
          </p>
